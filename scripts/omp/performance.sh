  ...
  do
    ...
    do
      ...
      do
        ...
        outdir="./omp-${N}_${dim}_${t}/$k"
        # generate input file for the test
        infile="omp-${N}_${dim}_${t}_${k}.dat"
        outfile="omp-${N}_${dim}_${t}_${k}.txt"
        ...
        then
          ...
          $QSUB -N "${t}_${k}_${N}_${dim}" \
                -v INFILE="$infile",OUTFILE="$outfile",OUTDIR="$outdir",EXECDIR="$EXEC_DIR",THREADS="$t" \
                submit.pbs
        else
